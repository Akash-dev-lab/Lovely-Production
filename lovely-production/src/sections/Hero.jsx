...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute top-20 right-0 w-[500px] h-[500px] bg-brand-400 rounded-full animate-pulse" />
        <div className="absolute bottom-20 left-0 w-[400px] h-[400px] bg-secondary rounded-full" />
      </div>

      <div className="container-custom relative z-10 text-center">
        <header className="max-w-4xl mx-auto">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-brand-50/50 dark:bg-brand-500/10 text-brand-700 dark:text-brand-400 text-sm font-medium mb-8 border border-brand-100 dark:border-brand-500/20 backdrop-blur-md">
            <span className="flex h-2 w-2 rounded-full bg-brand-500 mr-2 animate-pulse" aria-hidden="true" />
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-20">
          <Button size="lg" className="h-16 px-10 text-lg shadow-neon-indigo hover:neon-glow-primary transition-all duration-500" aria-label="Begin your project today">
            {cta}
          </Button>
        </div>
        ...
        <div className="relative mx-auto max-w-5xl group">
          <div className="absolute -inset-4 bg-linear-to-r from-brand-600 to-secondary opacity-30 blur-3xl -z-10 group-hover:opacity-50 transition duration-1000"></div>
